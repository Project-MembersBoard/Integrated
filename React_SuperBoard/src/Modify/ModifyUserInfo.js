...
export default function BeforeModifyUI(){

    const navigate = useNavigate();

    const [pw, setPw] = useState({userid: "",password:""});
    ...
    const checkPw = async (e) => {
        ...
        try {
            const response = await fetch(`${URL}/modify/checkUser`, {
                method: 'POST',
                headers: {
    ...
    return(
        ...
        <div className="BeforeModifyUIEntireDiv">
            ...
            <p className="BeforeModifyHeader" onClick={goHome}>Super Board</p>
